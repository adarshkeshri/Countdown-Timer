...
def timer(): 
    ...
    if timer_time >0:
        ...
        notification.notify(
            ...
            app_icon = "C:/Users/KIIT/Desktop/VSCoding/Projects/Countdown Timer/bell.ico",
            timeout  = 30,
        )
...
title_label_1 = Label(window, text="Countdown Timer with Notification",font=("Arial", 11)).pack()
title_label_2 = Label(window, text="HOURS   MINS    SECS",font=("Arial", 10)).pack()
hours = IntVar()
mins = IntVar()
secs = IntVar()
